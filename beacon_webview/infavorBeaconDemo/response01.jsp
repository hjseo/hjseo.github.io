...
{{/each}} 	
		...
		<style>
			...
			.text{height:50%; padding:0 6%;}
			.radio{height:20%; padding-top:8%; }
			.radio{height:20%; padding-top:8%; margin-left:-10%;}
			.radio input{margin-left:10%;}
			.btn{
				position:absolute; 
				left:0; bottom:0; 
				width:100%;
	...
	<body>
		<div id="wrap">
			...
			<div class="btn">
				<input id="btnSubmit" type="image" src="${pageContext.request.contextPath}/resources/images/beacon/demo/content01/btn01.gif" />
			</div>		
		</div>
	</body>
</html>