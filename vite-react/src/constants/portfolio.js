...
export const INTRODUCTION = {
  title: ['8년차 웹퍼블리셔', '서혜정입니다. >.<'],
  skills: [
    '- 기술: HTML5, CSS3, Tailwind CSS, Javascript(ES6), jQuery, React.js',
    '- 개발 환경: VSCode, Cursor, Git, SVN',
    '- 디자인 협업 도구: Figma, Zeplin, Photoshop'
  ],
  achievements: [
    '- [하나카드] 웹접근성 인증마크(2024년) 획득',
    '- [한국인터넷전문가협회 주최] 웹접근성 전문 교육 수료',
    '- 크로스브라우징(IE7까지) 등 다양한 경험 보유',
