            ...
            <div className="h-full block focus:outline-none focus:ring-2 focus:ring-cyan-500 rounded-lg">
                <div className="h-full relative overflow-hidden flex flex-col">
                    ...
                    <div className="px-6 flex-1 flex flex-col">
                        <h3 className="text-2xl font-semibold mb-4 md:min-h-[64px] transition-colors duration-300 group-hover:text-cyan-500">{item.title}</h3>
                    ...
                    <div className="px-6 pb-6 mt-auto relative">
                        ...
                        <span className={`absolute right-6 -top-6 text-sm font-medium
