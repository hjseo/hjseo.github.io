...
function nav_page_height() {
	...
	if (bodyHeight > windowHeight) {// if content height exceedes actual window height and menuHeight
		$.left_panel.css('min-height', bodyHeight + 'px');
 ...
 */
var datepicker_language2;

datepicker_language2 = navigator.language || navigator.browserLanguage;
datepicker_language2 = datepicker_language2.split('-')[0];
...
function runAllForms() {
	...
	if ($.fn.datepicker) {
		...
		$('.datepicker').each(function() {
			...
			var lenguageObj = $.datepicker.regional[datepicker_language2];
			lenguageObj.dateFormat = dataDateFormat;
			lenguageObj.prevText = '<i class="fa fa-chevron-left"></i>';
			lenguageObj.nextText = '<i class="fa fa-chevron-right"></i>';
