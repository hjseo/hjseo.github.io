...
(/** @lends <global> */function( $ ) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input class="form-control"  placeholder="Filter" type="text">') :
				  sSearchStr==="" ? '<input type="text" />' : '<input class="form-control"  placeholder="'+sSearchStr+'" type="text">';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			//nLength.innerHTML = '<span class="smart-form"><label class="select" style="width:60px">'+sStdMenu+'<i></i></label></span>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sUrl": PAGE_CONTEXT_PATH + "/resources/bootstrap/js/plugin/datatables/i18n/Korean.json",
